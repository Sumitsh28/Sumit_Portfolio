...
const SettingsDropdown = () => {
  ...
  return (
    <div className="settings-dropdown set">
      <section className="functions set">
        <div className="func set">
          <button className="airdrop-btn set" type="button">
            <MdWifiTethering fill="white" style={{ transition: "0.25 all" }} />
          </button>
          Airdrop
        </div>

        <div className="func set">
          <button className="set" type="button">
            <MdAnimation fill="white" style={{ transition: "0.25 all" }} />
          </button>
          Animations
        </div>
      </section>
      ...
      <section className="sys-colors set">
        ...
        <div className="colors set">
          <button
            ...
            onClick={changeColor}
          >
            {state.currentColor === "orangey" ? (
              <AiOutlineCheckCircle color={"#333333"} />
            ) : null}
          </button>
          <button
            ...
            onClick={changeColor}
          >
            {state.currentColor === "greeny" ? (
              <AiOutlineCheckCircle color={"#333333"} />
            ) : null}
          </button>
          <button className="color bluey set" id="bluey" onClick={changeColor}>
            {state.currentColor === "bluey" ? (
              <AiOutlineCheckCircle color={"#333333"} />
            ) : null}
          </button>
          <button className="color pinky set" id="pinky" onClick={changeColor}>
            {state.currentColor === "pinky" ? (
              <AiOutlineCheckCircle color={"#333333"} />
            ) : null}
          </button>
          <button
            ...
            onClick={changeColor}
          >
            {state.currentColor === "whitey" ? (
              <AiOutlineCheckCircle color={"#333333"} />
            ) : null}
          </button>
          <button className="color greyy set" id="greyy" onClick={changeColor}>
